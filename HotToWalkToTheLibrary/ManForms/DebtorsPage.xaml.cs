...
namespace HotToWalkToTheLibrary.ManForms
{
    public partial class DebtorsPage : Page
    {
        public DebtorsPage()
        {
            ...
            Class.ControlID.Sql = @"select * from Main where WhereIsBook like 'У читателя'";
        ...
        private void Search_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            string  sql = @"select * from Main where WhereIsBook like 'У читателя' and Main_ID like '%" + Search.Text + "%' or WhereIsBook like 'У читателя' and FIO like '%" + Search.Text + "%' or WhereIsBook like 'У читателя' and M_Book like '%" + Search.Text + "%' or WhereIsBook like 'У читателя' and DateGet like '%" + Search.Text + "%' or WhereIsBook like 'У читателя' and LastDate like '" + Search.Text + "'";
            try
            {
                SqlConnection con = new SqlConnection
                {
